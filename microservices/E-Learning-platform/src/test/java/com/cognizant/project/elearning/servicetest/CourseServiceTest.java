...
public class CourseServiceTest {
    ...
    public void setUp() {
        ...
        updateCourseDTO.setTitle("Java Programming");

        updateCourseDTO.setDescription("Learn Java from scratch");

        updateCourseDTO.setContentURL("http://example.com/java");

        updateCourseDTO.setImageURL("");
    ...
    public void testUpdateCourse_InvalidCourse() {
        ...
        assertThrows(InvalidCourse.class, () -> {
            ...
            courseService.updateCourse(1, 1, updateCourseDTO);
